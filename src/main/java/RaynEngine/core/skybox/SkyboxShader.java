package RaynEngine.core.skybox;
...
public class SkyboxShader extends ShaderProgram {
    ...
    private static final String VERTEX_FILE = GameLoader.fileHandler.getShader("skyboxVertexShader");
    private static final String FRAGMENT_FILE = GameLoader.fileHandler.getShader("skyboxFragmentShader");
