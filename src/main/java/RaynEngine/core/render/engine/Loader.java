...
import RaynEngine.core.misc.textures.TextureData;
...
public class Loader {
    ...
    public void updateVbo(int vbo, float[] data, FloatBuffer floatBuffer) {
        ...
        GL15.glBufferData(GL15.GL_ARRAY_BUFFER, floatBuffer.capacity() * 4, GL15.GL_STREAM_DRAW);
    ...
    public int loadTexture(String fileName) {
        ...
        try {
            texture = TextureLoader.getTexture("PNG", new FileInputStream(GameLoader.fileHandler.getTexture(fileName)));
    ...
    public int loadCubeMap(String[] textureFiles) {
        ...
        for (int i = 0; i < textureFiles.length; i++) {
            TextureData data = decodeTextureFile(GameLoader.fileHandler.getTexture(textureFiles[i]));
