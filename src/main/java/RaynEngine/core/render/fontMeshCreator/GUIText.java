package RaynEngine.core.render.fontMeshCreator;
...
/**
 * Represents a piece of text in the wiz.
 *
 * @author Karl
 */
public class GUIText {
    ...
    private float width, edge, borderWidth, borderEdge;
    ...
    /**
     * Get offset of text (for drop shadows).
     * @return
     */
    ...
    /**
     * Sets the offset of the dropshadow
     * @param offset
     */
    ...
    /**
     * @return drop shadow/border color
     */
    ...
    /**
     * Sets the border/drop shadow color
     * @param outlineColor
     */
