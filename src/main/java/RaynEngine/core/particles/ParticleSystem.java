...
public class ParticleSystem {
    ...
    /**
     * @param direction - The average direction in which RaynEngine.core.particles are emitted.
     * @param deviation - A value between 0 and 1 indicating how far from the chosen direction RaynEngine.core.particles can deviate.
     */
