...
public class WaterShader extends ShaderProgram {
	...
	private final static String VERTEX_FILE = GameLoader.fileHandler.getShader("waterVertex");
	private final static String FRAGMENT_FILE = GameLoader.fileHandler.getShader("waterFragment");
